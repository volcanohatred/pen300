# Begin of ProxyCommand for command: Get-Process
# Generated with Peter Kriegel's New-ProxyCommand.ps1
#	https://gallery.technet.microsoft.com/scriptcenter/New-ProxyCommand-a-simple-9735745e
...
#>
	...
	[CmdletBinding(DefaultParameterSetName='Name', HelpUri='https://go.microsoft.com/fwlink/?LinkID=113324', RemotingCapability='SupportedByCommand')]
 	param(
 	...
 	begin
 	{
 	    try {
 	        ...
 	        $scriptCmd = {& $wrappedCmd @PSBoundParameters | ? {$_.ProcessName -notmatch 'powershell'} }
...
} # End ProxyFunction for command: Get-Process